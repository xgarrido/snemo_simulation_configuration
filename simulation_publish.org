...
#+BEGIN_SRC latex
  ...
  \renewcommand{\footnoterule}{\color{mainColor!90}%
    \vskip-\footruleskip\vskip-\footrulewidth%
    \vspace{10pt}\hrule width\columnwidth height1.5pt \vspace{5pt} \color{mainColor!90}}
...
#+BEGIN_SRC emacs-lisp
      (add-to-list
       ...
       `("pdf-documentation"
         ...
         :exclude "simulation_publish.org\\|simulation_config.org\\|sng4_manager.org\\|sngenbb_manager.org\\|step_hit_processor_factory.org"
         :section-numbers nil
         :with-toc        nil
         :latex-class "snemo-simu"
         :latex-header-extra "
  \\definecolor{blue}{RGB}{0,72,112}
  \\colorlet{sncolor}{blue}
    "
         ))

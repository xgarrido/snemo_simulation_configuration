...
#+BEGIN_SRC latex
  ...
  \renewcommand{\footnoterule}{\color{blue!90}%
    \vskip-\footruleskip\vskip-\footrulewidth%
    \vspace{10pt}\hrule width\columnwidth height1.5pt \vspace{5pt} \color{blue!90}}
...
#+BEGIN_SRC emacs-lisp
  (add-to-list
   ...
   `("pdf-documentation"
     ...
     :exclude "simulation_publish.org\\|sng4_manager.org\\|simulation_config.org\\|sngenbb_manager.org\\|step_hit_processor_factory.org"
     :section-numbers 2
     :with-toc        t

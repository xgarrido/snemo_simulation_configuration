  ...
  (let* ((this-dir (file-name-directory (or load-file-name buffer-file-name))))
    ...
    (add-to-list
     ...
     `("simulation-documentation"
       ...
       :base-extension "org"
       :publishing-directory ,(expand-file-name "doc/html" this-dir)
    ...
    (copy-file (expand-file-name "simulation_config.html" (expand-file-name "doc/html" this-dir))
               (expand-file-name "index.html" (expand-file-name "doc/html" this-dir)) t))
  #+END_SRC

...
#+BEGIN_SRC sh
  ...
  modules.configuration_files : string[8] as path =                         \
      ...
      "@SNEMO_SIMULATION_CONFIGURATION@/analysis_modules.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  pool.histo.setups : string[2] as path =                         \
      "@SNEMO_SIMULATION_CONFIGURATION@/basic_histograms.conf" \
      "@SNEMO_SIMULATION_CONFIGURATION@/histogram_templates.conf"
#+END_SRC

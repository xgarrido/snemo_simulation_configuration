...
#+BEGIN_SRC sh
  ...
  modules.configuration_files : string[9] as path =                      \
...
*** Update informations
#+BEGIN_SRC sh
  [name="update_header" type="snemo::analysis::processing::event_header_utils_module"]
  ...
  mode.add_header.update : boolean = 1
...
#+BEGIN_SRC sh
  delayed_drift_time_threshold : real as time = 20 us
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  #@description Activate the check for special traits of tracker hit
  mode.tracker_hit_has_traits : boolean = 1

  #@description Traits bit name to look for
  tracker_hit_has_traits.bits_name : string[1] = "delayed"
#+END_SRC

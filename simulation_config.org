...
#+BEGIN_SRC sh
  ...
  if [ -z ${ofilename} ]; then
      echo 'output.single.filename : string as path = "'$IO_OUTPUT_DIRECTORY/$mname'.brio"'
  else
      echo 'output.single.filename : string as path = "'$ofilename'"'
  fi
  echo
...
#+NAME: remove_module
#+HEADERS: :var mname="" :var mode="remove_bank" :var label="" :var logging="notice"
#+BEGIN_SRC sh
...
#+NAME: chain_module
#+HEADERS: :var mname="" :var nmodule=0 :var list="" :var logging="notice"
#+BEGIN_SRC sh
...
#+NAME: if_module
#+HEADERS: :var mname="" :var cut="" :var then="" :var else="" :var logging="notice"
#+BEGIN_SRC sh
...
*** Simulation output
#+BEGIN_SRC sh :noweb yes
  <<output_module("io_output_simulated", logging="notice")>>
#+END_SRC

*** Calibration output
#+BEGIN_SRC sh :noweb yes
  <<output_module("io_output_calibrated", logging="notice")>>
#+END_SRC

*** Tracker clustering output
#+BEGIN_SRC sh :noweb yes
  <<output_module("io_output_tracker_clustering", logging="notice")>>
#+END_SRC

*** Tracker trajectory output
#+BEGIN_SRC sh :noweb yes
  <<output_module("io_output_tracker_trajectory", logging="notice")>>
#+END_SRC

*** Analysis output
#+BEGIN_SRC sh :noweb yes
  <<output_module("io_output_analysed", logging="notice")>>
#+END_SRC
...
- Calibration cuts
  #+BEGIN_SRC sh :noweb yes
    <<output_module("io_output_calibrated_selected",     logging="notice")>>
    <<output_module("io_output_calibrated_non_selected", logging="notice")>>
  #+END_SRC

- Tracking cuts
  #+BEGIN_SRC sh :noweb yes
    <<output_module("io_output_tracker_clustering_selected",     logging="notice")>>
    <<output_module("io_output_tracker_clustering_non_selected", logging="notice")>>
  #+END_SRC

- Fitting cuts
  #+BEGIN_SRC sh :noweb yes
    <<output_module("io_output_tracker_trajectory_selected",     logging="notice")>>
    <<output_module("io_output_tracker_trajectory_non_selected", logging="notice")>>
  #+END_SRC

- Particle track cuts
  #+BEGIN_SRC sh :noweb yes
    <<output_module("io_output_particle_track_selected",     logging="notice")>>
    <<output_module("io_output_particle_track_non_selected", logging="notice")>>
  #+END_SRC
...
*** Remove event header
#+BEGIN_SRC sh :noweb yes
  <<remove_module(mname="remove_header", label="EH", logging="notice")>>
#+END_SRC

*** Remove MC visual hits
#+BEGIN_SRC sh :noweb yes
  <<remove_module(mname="remove_mc_visu_hits", mode="remove_mc_hits", label="__visu.tracks", logging="notice")>>
#+END_SRC

*** Remove simulated data bank
#+BEGIN_SRC sh :noweb yes
  <<remove_module(mname="remove_simulated_data", label="SD", logging="notice")>>
#+END_SRC

*** Remove calibrated data bank
#+BEGIN_SRC sh :noweb yes
  <<remove_module(mname="remove_calibrated_data", label="CD", logging="notice")>>
#+END_SRC

*** Remove tracker clustering data bank
#+BEGIN_SRC sh :noweb yes
  <<remove_module(mname="remove_tracker_clustering_data", label="TCD", logging="notice")>>
#+END_SRC
*** Remove tracker trajectory data bank
#+BEGIN_SRC sh :noweb yes
  <<remove_module(mname="remove_tracker_trajectory_data", label="TTD", logging="notice")>>
#+END_SRC
*** Remove particle track data bank
#+BEGIN_SRC sh :noweb yes
  <<remove_module(mname="remove_particle_track_data", label="PTD", logging="notice")>>
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  manager.configuration_filename : string as path = "${SNAILWARE_SIMULATION_DIR}/configuration/current/sng4_manager.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  [name="add_header" type="dpp::utils_module"]
...
#+BEGIN_SRC sh
  ...
  mode.add_header.external_properties_path : \
      string as path = "${SNAILWARE_SIMULATION_DIR}/configuration/current/simulation_header.conf"
...
#+BEGIN_SRC sh :tangle no
  ...
  #@description Logging priority
  logging.priority : string = "verbose"

  #@description File from which the context is to be loaded at program start
  load.file : string as path  = "/tmp/${USER}/snemo_context.conf"

  #@description File to store the context at program termination
  store.file : string as path = "/tmp/${USER}/snemo_context_end.conf"

  #@description Flag to backup the former context load file
  backup.file : string as path = "/tmp/${USER}/snemo_context_bak.conf"
#+END_SRC
...
#+NAME: has_bank
#+HEADERS: :var cname="" :var mode="has_bank" :var bname="" :var btype="" :var logging="notice"
#+BEGIN_SRC sh
...
#+NAME: multi
#+HEADERS: :var cname="" :var mode="and" :var ncut=0 :var list="" :var logging="notice"
#+BEGIN_SRC sh
...
#+BEGIN_SRC sh
  [name="Histo" type="mygsl::histogram_service"]

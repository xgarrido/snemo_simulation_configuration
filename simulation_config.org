...
** Module manager
:PROPERTIES:
:HEADER-ARGS: :tangle module_manager.conf
:END:
...
** Service manager
:PROPERTIES:
:HEADER-ARGS: :tangle service_manager.conf
:END:
*** Logging priority
#+BEGIN_SRC shell
...
|-------------------------+---------------------------------------------------------------|
| Bayeux_mctools_geant4   | @bxdll:libBayeux_mctools_geant4.so                           |
| Falaise                 | @fldll:libFalaise.so                                         |
| Falaise_MTC             | @fldll:Falaise/modules/libFalaise_MockTrackerClusterizer.so  |
| Falaise_CAT             | @fldll:Falaise/modules/libFalaise_CAT.so                     |
| TrackFit                | @fldll:Falaise/modules/libTrackFit.so                        |
| Falaise_TrackFit        | @fldll:Falaise/modules/libFalaise_TrackFit.so                |
| Falaise_CPT             | @fldll:Falaise/modules/libFalaise_ChargedParticleTracking.so |
| GammaTracking           | @fldll:Falaise/modules/libGammaTracking.so                   |
| Falaise_GammaTracking   | @fldll:Falaise/modules/libFalaise_GammaTracking.so           |
| Falaise_GammaClustering | @fldll:Falaise/modules/libFalaise_GammaClustering.so         |
| Falaise_PID             | @fldll:Falaise/modules/libFalaise_ParticleIdentification.so  |
| Falaise_ProcessReport   | @fldll:Falaise/modules/libFalaise_ProcessReport.so           |
# | Falaise_TopologyExporter | @fldll:Falaise/modules/libFalaise_TopologyExporter.so        |
|--------------------------+-------------------------------------------------------------------------------------|
...
** I/O modules
:PROPERTIES:
:HEADER-ARGS: :tangle io_modules.conf
:END:
...
** Utility modules
:PROPERTIES:
:HEADER-ARGS: :tangle utl_modules.conf
:END:
...
** Simulation module
:PROPERTIES:
:HEADER-ARGS: :tangle simulation_modules.conf
:END:
*** Insert preamble
#+BEGIN_SRC shell :noweb yes
  <<module_preamble>>
...
**** Seed values
#+BEGIN_SRC shell
  #@variant_if simulation:random_seed_flag/is_inactive|true
  ...
  #@variant_if simulation:random_seed_flag/is_active|false
  #@description The simulation manager PRNG seed
  ...
  manager.output_prng_seeds_file : string as path = @variant(core:output_path)/prng_seeds.save

  #@description The saving of PRNG states
  manager.output_prng_states_file : string as path = @variant(core:output_path)/prng_states.save
...
** Event header module
:PROPERTIES:
:HEADER-ARGS: :tangle event_header_modules.conf
:END:
...
:PROPERTIES:
:HEADER-ARGS: :tangle snsimulation_header.conf
:END:
...
** Calibration modules
:PROPERTIES:
:HEADER-ARGS: :tangle calibration_modules.conf
:END:
*** Insert preamble
#+BEGIN_SRC shell :noweb yes
  <<module_preamble>>
...
:PROPERTIES:
:HEADER-ARGS: :tangle tracker_clustering_modules.conf
:END:
*** Insert preamble
#+BEGIN_SRC shell :noweb yes
  <<module_preamble>>
...
:PROPERTIES:
:HEADER-ARGS: :tangle tracker_fitting_modules.conf
:END:
*** Insert preamble
#+BEGIN_SRC shell :noweb yes
  <<module_preamble>>
...
:PROPERTIES:
:HEADER-ARGS: :tangle particle_tracking_modules.conf
:END:
*** Insert preamble
#+BEGIN_SRC shell :noweb yes
  <<module_preamble>>
...
:PROPERTIES:
:HEADER-ARGS: :tangle gamma_tracking_modules.conf
:END:
*** Insert preamble
#+BEGIN_SRC shell :noweb yes
  <<module_preamble>>
...
** Topology module
:PROPERTIES:
:HEADER-ARGS: :tangle topology_modules.conf
:END:
...
** Chain modules
:PROPERTIES:
:HEADER-ARGS: :tangle chain_modules.conf
:END:
...
#+BEGIN_SRC shell :noweb yes
  <<chain_module("channel_chain", 10, channel_chain)>>
#+END_SRC
** Miscellaneous
:PROPERTIES:
:HEADER-ARGS: :tangle misc_modules.conf
:END:
*** Insert preamble
#+BEGIN_SRC shell :noweb yes
  <<module_preamble>>
...
*** Topology exporter
#+BEGIN_SRC shell
  [name="topology_exporter" type="snemo::processing::topology_exporter_module"]
#+END_SRC
**** Logging priority
#+BEGIN_SRC shell
  #@description Logging flag
...
* Services
:PROPERTIES:
:HEADER-ARGS: :tangle services.conf
:END:
...
:PROPERTIES:
:HEADER-ARGS: :tangle cut_manager.conf
:END:
...
*** Event header cut
:PROPERTIES:
:HEADER-ARGS: :tangle event_header_cuts.conf
:END:
...
:PROPERTIES:
:HEADER-ARGS: :tangle simulated_data_cuts.conf
:END:
...
:PROPERTIES:
:HEADER-ARGS: :tangle calibrated_data_cuts.conf
:END:
...
:PROPERTIES:
:HEADER-ARGS: :tangle tracker_clustering_data_cuts.conf
:END:
...
:PROPERTIES:
:HEADER-ARGS: :tangle tracker_trajectory_data_cuts.conf
:END:
...
:PROPERTIES:
:HEADER-ARGS: :tangle particle_track_data_cuts.conf
:END:
...
*** PID selection
:PROPERTIES:
:HEADER-ARGS: :tangle pid_cuts.conf
:END:
...
*** Channel selection
:PROPERTIES:
:HEADER-ARGS: :tangle topology_cuts.conf
:END:

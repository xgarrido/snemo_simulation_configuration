...
#+BEGIN_SRC sh
  ...
  modules.configuration_files : string[4] as path =                                   \
...
#+BEGIN_SRC sh :noweb yes
  ...
  <<if_module("process_with_calibrated_cuts", cut="calibrated_cut", then="io_output_calibrated_selected", else="io_output_calibrated_non_selected")>>
#+END_SRC

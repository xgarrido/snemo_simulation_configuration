...
#+BEGIN_SRC sh
  ...
  #@description Cut description
  cut.description : string = "Select a tracker cluster"
...
#+BEGIN_SRC sh :noweb yes
  <<multi(cname="tracker_clustering_cut", "and", 3, tracker_clustering_cuts)>>
#+END_SRC
...
#+BEGIN_SRC sh
  [name="has_associated_calorimeter" type="snemo::cut::particle_track_data_cut"]

  #@description Cut description
  cut.description : string = "Select association particle/calorimeter"
...
#+BEGIN_SRC sh
  [name="range_associated_calorimeters" type="snemo::cut::particle_track_data_cut"]

  #@description Cut description
  cut.description : string = "Select a number of associated calorimeter to one particle"

...
#+BEGIN_SRC shell :noweb yes
  <<chain_module("channel_chain", 2, channel_chain)>>
#+END_SRC
** Chain modules
:PROPERTIES:
...
#+BEGIN_SRC shell :noweb yes
  <<multi("2e_channel_cut", "and", 5, 2e_channel_cut)>>
#+END_SRC
...
#+BEGIN_SRC shell :noweb yes
  <<multi("1e_channel_cut", "and", 3, 1e_channel_cut)>>
#+END_SRC
...
#+BEGIN_SRC shell :noweb yes
  <<multi("1e1g_channel_cut", "and", 3, 1e1g_channel_cut)>>
#+END_SRC
...
#+BEGIN_SRC shell :noweb yes
  <<multi("1e1a_channel_cut", "and", 3, 1e1a_channel_cut)>>
#+END_SRC

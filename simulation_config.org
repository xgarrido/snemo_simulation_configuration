...
#+BEGIN_SRC sh
  ...
  service_manager.configuration : string[1] as path = \
      "${SNAILWARE_SIMULATION_DIR}/current/service_manager.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  modules.configuration_files : string[8] as path =                         \
      "${SNAILWARE_SIMULATION_DIR}/current/io_modules.conf"                 \
      "${SNAILWARE_SIMULATION_DIR}/current/utl_modules.conf"                \
      "${SNAILWARE_SIMULATION_DIR}/current/simulation_modules.conf"         \
      "${SNAILWARE_SIMULATION_DIR}/current/calibration_modules.conf"        \
      "${SNAILWARE_SIMULATION_DIR}/current/tracker_clustering_modules.conf" \
      "${SNAILWARE_SIMULATION_DIR}/current/tracker_fitting_modules.conf"    \
      "${SNAILWARE_SIMULATION_DIR}/current/particle_tracking_modules.conf"  \
      "${SNAILWARE_SIMULATION_DIR}/current/analysis_modules.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  services.configuration_files : string[1] as path = \
      "${SNAILWARE_SIMULATION_DIR}/current/services.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  manager.configuration_filename : string as path = \
      "${SNAILWARE_SIMULATION_DIR}/current/sng4_manager.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  mode.add_header.external_properties_path : string as path = \
      "${SNAILWARE_SIMULATION_DIR}/current/snsimulation_header.conf"
...
#+BEGIN_SRC sh
  ...
  manager.configuration_file : string as path = \
      "${SNAILWARE_SIMULATION_DIR}/current/sngeometry_manager.conf"
...
#+BEGIN_SRC sh
  ...
  cut_manager.config : string as path = \
      "${SNAILWARE_SIMULATION_DIR}/current/cut_manager.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  cuts.configuration_files : string[5] as path =                            \
    "${SNAILWARE_SIMULATION_DIR}/current/simulated_data_cuts.conf"          \
    "${SNAILWARE_SIMULATION_DIR}/current/calibrated_data_cuts.conf"         \
    "${SNAILWARE_SIMULATION_DIR}/current/tracker_clustering_data_cuts.conf" \
    "${SNAILWARE_SIMULATION_DIR}/current/tracker_trajectory_data_cuts.conf" \
    "${SNAILWARE_SIMULATION_DIR}/current/particle_track_data_cuts.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  pool.histo.setups : string[2] as path =                         \
      "${SNAILWARE_SIMULATION_DIR}/current/basic_histograms.conf" \
      "${SNAILWARE_SIMULATION_DIR}/current/histogram_templates.conf"
#+END_SRC

...
#+BEGIN_SRC shell
  ...
  trackfit.helix.guess.fit_delayed_clusters : boolean = 0
#+END_SRC
****** Fit parameters
#+BEGIN_SRC shell
...
#+BEGIN_SRC shell
  #@description List of drivers to be used (see description below)
  drivers : string[2] = "TOFD" "DVD"
#+END_SRC
**** Time-Of-Flight driver
***** Logging priority
#+BEGIN_SRC shell
  #@description Logging flag
  TOFD.logging.priority : string = "trace"
#+END_SRC
...
#+BEGIN_SRC shell
  #@description Logging flag
  DVD.logging.priority : string = "trace"
#+END_SRC
...
*** 2\beta selection
#+BEGIN_SRC shell :noweb yes
  <<output_module("io_output_2e_topology_selected")>>
  <<output_module("io_output_2e_topology_non_selected")>>
  <<if_module("process_2e_topology_cut", cut="2e_topology_cut", then="io_output_2e_topology_selected", else="io_output_2e_topology_non_selected")>>
#+END_SRC

*** 1\beta selection
#+BEGIN_SRC shell :noweb yes
  <<output_module("io_output_1e_topology_selected")>>
  <<output_module("io_output_1e_topology_non_selected")>>
  <<if_module("process_1e_topology_cut", cut="1e_topology_cut", then="io_output_1e_topology_selected", else="io_output_1e_topology_non_selected")>>
#+END_SRC

*** 1\beta/1\gamma selection
#+BEGIN_SRC shell :noweb yes
  <<output_module("io_output_1e1g_topology_selected")>>
  <<output_module("io_output_1e1g_topology_non_selected")>>
  <<if_module("process_1e1g_topology_cut", cut="1e1g_topology_cut", then="io_output_1e1g_topology_selected", else="io_output_1e1g_topology_non_selected")>>
#+END_SRC
*** 1\beta/1\alpha selection
#+BEGIN_SRC shell :noweb yes
  <<output_module("io_output_1e1a_topology_selected")>>
  <<output_module("io_output_1e1a_topology_non_selected")>>
  <<if_module("process_1e1a_topology_cut", cut="1e1a_topology_cut", then="io_output_1e1a_topology_selected", else="io_output_1e1a_topology_non_selected")>>
#+END_SRC

*** Full topology
#+CAPTION: *Topology chain.*
#+TBLNAME: topology_chain
|---------------------------|
| minimum_bias_chain        |
| process_2e_topology_cut   |
| process_1e_topology_cut   |
| process_1e1g_topology_cut |
| process_1e1a_topology_cut |
|---------------------------|

#+BEGIN_SRC shell :noweb yes
  <<chain_module("topology_chain", 2, topology_chain)>>
#+END_SRC
** Chain modules
:PROPERTIES:
...
#+BEGIN_SRC shell :noweb yes
  <<multi("alpha_definition", "and", 2, alpha_definition)>>
#+END_SRC
...
Define 2\beta events topology

- select 2 electrons event topology :
  #+BEGIN_SRC shell
  [name="2e_topology_pattern" type="snemo::cut::topology_cut"]
...
- select events with internal probability :
  #+BEGIN_SRC shell
    [name="2e_has_internal_probability" type="snemo::cut::topology_cut"]
    ...
    mode.has_internal_probability : boolean = 1
  #+END_SRC

- select events with good internal probability :
  #+BEGIN_SRC shell
    [name="2e_range_internal_probability" type="snemo::cut::topology_cut"]
    ...
    mode.range_internal_probability : boolean = 1

    #@description Minimal value for internal probability
    #internal_probability.min : real as percent = 5 %
    range_internal_probability.min : real = 0.01
  #+END_SRC

The following cut combines all the previous ones to define what 2 electrons
events are
#+CAPTION: *Definition of 2 electrons topology.*
#+TBLNAME: 2e_topology_cut
|-------------------------------|
| has_particle_track_data       |
| has_particle                  |
| 2e_topology_pattern           |
| 2e_has_internal_probability   |
| 2e_range_internal_probability |
|-------------------------------|

#+BEGIN_SRC shell :noweb yes
  <<multi("2e_topology_cut", "and", 5, 2e_topology_cut)>>
#+END_SRC

**** 1\beta selection

Define 1\beta events topology

#+BEGIN_SRC shell
  [name="1e_cut" type="snemo::cut::topology_cut"]
  ...
  #@description Minimal number of electrons
  electron_range.min : integer = 1

  #@description Maximal number of electrons
  electron_range.max : integer = 1
#+END_SRC

#+CAPTION: *Definition of 1 electron topology.*
#+TBLNAME: 1e_topology_cut
|-------------------------|
| has_particle_track_data |
| has_particle            |
| 1e_cut                  |
...
#+BEGIN_SRC shell :noweb yes
  <<multi("1e_topology_cut", "and", 3, 1e_topology_cut)>>
#+END_SRC

**** 1\beta1\gamma selection

Define 1\beta1\gamma events topology

#+BEGIN_SRC shell
  [name="1e1g_cut" type="snemo::cut::topology_cut"]
  ...
  #@description Minimal number of gammas
  gamma_range.min : integer = 1

  #@description Maximal number of gammas
  gamma_range.max : integer = 1
#+END_SRC

#+CAPTION: *Definition of 1\beta1\gamma topology.*
#+TBLNAME: 1e1g_topology_cut
|-------------------------|
| has_particle_track_data |
| has_particle            |
| 1e1g_cut                |
...
#+BEGIN_SRC shell :noweb yes
  <<multi("1e1g_topology_cut", "and", 3, 1e1g_topology_cut)>>
#+END_SRC
...
#+BEGIN_SRC shell
  [name="1e1a_cut" type="snemo::cut::topology_cut"]
  ...
  #@description Minimal number of alphas
  alpha_range.min : integer = 1

  #@description Maximal number of alphas
  alpha_range.max : integer = 1
#+END_SRC

#+CAPTION: *Definition of 1\beta1\alpha topology.*
#+TBLNAME: 1e1a_topology_cut
|-------------------------|
| has_particle_track_data |
| has_particle            |
| 1e1a_cut                |
...
#+BEGIN_SRC shell :noweb yes
  <<multi("1e1a_topology_cut", "and", 3, 1e1a_topology_cut)>>
#+END_SRC

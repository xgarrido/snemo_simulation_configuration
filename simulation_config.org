...
#+BEGIN_SRC shell
  ...
  echo
  echo '#@description The running mode of this cut instance'
  echo 'mode.range_associated_calorimeter_hits : boolean = 1'
  echo
  if [ ! -z $category ]; then
...
- a delayed cluster
  #+BEGIN_SRC shell
    ...
    mode.has_delayed_cluster : boolean = 1
  #+END_SRC
- a vertex on the source foil
  #+BEGIN_SRC shell :noweb yes
...
#+BEGIN_SRC shell
  ...
  echo
  echo '#@description The running mode of this cut instance'
  echo 'mode.has_particles : boolean = 1'
#+END_SRC
...
#+BEGIN_SRC shell
  ...
  echo
  echo '#@description The running mode of this cut instance'
  echo 'mode.has_pattern_id : boolean = 1'
#+END_SRC

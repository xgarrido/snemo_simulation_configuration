...
#+BEGIN_SRC shell
  ...
  pid.definitions : string[1] = "electron::definition"

  # #@description The label associated to definition
  # pid.electron::definition.label : string = "snemo::electron"
#+END_SRC
...
#+BEGIN_SRC shell :noweb yes
  <<multi("electron::definition", "and", 3, electron_cuts)>>
#+END_SRC

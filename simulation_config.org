...
#+BEGIN_SRC shell
    ...
    if [ -z ${ofilename} ]; then
        echo 'files.single.path : string as path = @variant(core:io|"/tmp/${USER}/snemo.d/")'
        echo
...
#+BEGIN_SRC shell
  ...
  manager.seed : integer = @variant(core:irs/if_random_seed/null_seed|2)

  #@description The vertex generator PRNG seed
  manager.vertex_generator_seed : integer = @variant(core:irs/if_random_seed/null_seed|4)

  #@description The event generator PRNG seed
  manager.event_generator_seed  : integer = @variant(core:irs/if_random_seed/null_seed|5)

  #@description The SHPF PRNG seed
  manager.shpf_seed : integer = @variant(core:irs/if_random_seed/null_seed|6)
...
#+BEGIN_SRC shell
  ...
  manager.vertex_generator_name : string  = @variant(core:vg|"source_strips_bulk")
#+END_SRC
...
#+BEGIN_SRC shell
  ...
  manager.event_generator_name : string  = @variant(core:eg|"Se82.0nubb")
#+END_SRC
**** G4 manager
...
#+BEGIN_SRC shell
  ...
  analysis.vertex_origin : string = @variant(core:vg|"source_strips_bulk")
#+END_SRC
...
#+BEGIN_SRC shell
  ...
  calo.energy.resolution  : real as fraction = @variant(core:cer|"8 %")
  xcalo.energy.resolution : real as fraction = @variant(core:xer|"12 %")
  gveto.energy.resolution : real as fraction = @variant(core:ger|"15 %")
#+END_SRC

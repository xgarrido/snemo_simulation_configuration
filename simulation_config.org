...
#+BEGIN_SRC sh
  ...
  manager.configuration_filename : string = "${SNAILWARE_SIMULATION_DIR}/snemo_configuration/current/sng4_manager.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  mode.add_header.external_properties_path : \
      string = "${SNAILWARE_SIMULATION_DIR}/snemo_configuration/current/simulation_header.conf"
...
#+BEGIN_SRC sh :tangle simulation_header.conf
  ...
  analysis.description : string = "Study the calorimeter energy resolution"
...
#+BEGIN_SRC sh
  ...
  cut_manager.config : string = "${SNAILWARE_SIMULATION_DIR}/snemo_configuration/current/cut_manager.conf"
#+END_SRC
...
Embedded histograms are declared into a dedicated file defines in file

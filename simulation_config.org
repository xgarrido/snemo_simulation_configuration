...
#+BEGIN_SRC shell
  ...
  manager.vertex_generator_name : string  = @variant(simulation:vertex_generator|"source_strips_bulk")
#+END_SRC
...
#+BEGIN_SRC shell
  ...
  manager.event_generator_name : string  = @variant(simulation:event_generator|"Se82.0nubb")
#+END_SRC
**** G4 manager

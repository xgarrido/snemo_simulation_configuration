...
*** \gamma track output
#+BEGIN_SRC sh :noweb yes
  <<output_module("io_output_gamma_track")>>
#+END_SRC
...
*** \gamma tracking chain
#+CAPTION: *Modules used by the \gamma tracking process.*
#+TBLNAME: gamma_tracking_chain
|-----------------------|
| gamma_tracking        |
| io_output_gamma_track |
|-----------------------|

#+BEGIN_SRC sh :noweb yes
  <<chain_module("gamma_tracking_chain", 2, gamma_tracking_chain)>>
#+END_SRC

*** Process after selecting particle track
#+BEGIN_SRC sh :noweb yes
   <<if_module("process_with_particle_track_cuts", cut="particle_track_cut", then="gamma_tracking_chain", else="io_output_particle_track_non_selected")>>
#+END_SRC

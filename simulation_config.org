...
#+LATEX_HEADER: \usemintedstyle{upsud}
...
#+BEGIN_SRC sh
  ...
  modules.configuration_files : string[6] =                        \
      "${SNSW_SIMULATION_DIR}/configuration/io_modules.conf"       \
      "${SNSW_SIMULATION_DIR}/configuration/utl_modules.conf"      \
      "${SNSW_SIMULATION_DIR}/configuration/s2c_modules.conf"      \
      "${SNSW_SIMULATION_DIR}/configuration/tracker_modules.conf"  \
      "${SNSW_SIMULATION_DIR}/configuration/analysis_modules.conf" \
      "${SNSW_SIMULATION_DIR}/configuration/plot_modules.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  manager.configuration_file : string = "${SNGEOMETRY_DATA_DIR}/resources/setups/snemo/config_2.0/manager.conf"
...
#+BEGIN_SRC sh
  ...
  cut_manager.config : string = "${SNSW_SIMULATION_DIR}/configuration/cut_manager.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  cuts.configuration_files : string[4] =                                     \
    "${SNSW_SIMULATION_DIR}/configuration/simulated_data_cuts.conf"          \
    "${SNSW_SIMULATION_DIR}/configuration/calibrated_data_cuts.conf"         \
    "${SNSW_SIMULATION_DIR}/configuration/tracker_clustering_data_cuts.conf" \
    "${SNSW_SIMULATION_DIR}/configuration/particle_track_data_cuts.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  range_hit_category.min : integer = 0

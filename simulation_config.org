...
#+BEGIN_SRC shell :noweb yes
  ...
  <<if_module("process_2e_channel_cut", cut="2e_channel_cut", then="io_output_2e_channel_selected", else="io_output_2e_channel_non_selected")>>
#+END_SRC
...
#+BEGIN_SRC shell :noweb yes
  ...
  <<if_module("process_1e_channel_cut", cut="1e_channel_cut", then="io_output_1e_channel_selected", else="io_output_1e_channel_non_selected")>>
#+END_SRC
...
#+BEGIN_SRC shell :noweb yes
  ...
  <<if_module("process_1e1g_channel_cut", cut="1e1g_channel_cut", then="io_output_1e1g_channel_selected", else="io_output_1e1g_channel_non_selected")>>
#+END_SRC
*** 1\beta/1\alpha selection
#+BEGIN_SRC shell :noweb yes
  <<output_module("io_output_1e1a_channel_selected")>>
  <<output_module("io_output_1e1a_channel_non_selected")>>
  <<if_module("process_1e1a_channel_cut", cut="1e1a_channel_cut", then="io_output_1e1a_channel_selected", else="io_output_1e1a_channel_non_selected")>>
#+END_SRC
...
**** Generic selection
#+BEGIN_SRC shell
  [name="has_pattern_id" type="snemo::cut::topology_data_cut"]

  #@description Cut description
  cut.description : string = "Ensure pattern id presence"

  #@description Logging priority
  logging.priority : string = "trace"

  #@description Activate the check for pattern id label
  mode.has_pattern_id : boolean = 1
#+END_SRC
...
- select 2 electrons event topology :
  #+BEGIN_SRC shell
  [name="2e_topology_pattern" type="snemo::cut::topology_data_cut"]
...
- select events with internal probability :
  #+BEGIN_SRC shell
    [name="2e_has_internal_probability" type="snemo::cut::channel_2e_cut"]
...
- select events with good internal probability :
  #+BEGIN_SRC shell
    [name="2e_range_internal_probability" type="snemo::cut::channel_2e_cut"]
...
#+BEGIN_SRC shell :noweb yes
  <<multi("2e_channel_cut", "and", 6, 2e_channel_cut)>>
#+END_SRC
...
#+BEGIN_SRC shell
  [name="1e_cut" type="snemo::cut::topology_data_cut"]
...
#+BEGIN_SRC shell :noweb yes
  <<multi("1e_channel_cut", "and", 4, 1e_channel_cut)>>
#+END_SRC
...
#+BEGIN_SRC shell
  [name="1e1g_cut" type="snemo::cut::topology_data_cut"]
...
#+BEGIN_SRC shell :noweb yes
  <<multi("1e1g_channel_cut", "and", 4, 1e1g_channel_cut)>>
#+END_SRC
...
#+BEGIN_SRC shell
  [name="1e1a_cut" type="snemo::cut::topology_data_cut"]
...
#+BEGIN_SRC shell :noweb yes
  <<multi("1e1a_channel_cut", "and", 4, 1e1a_channel_cut)>>
#+END_SRC

...
| Falaise_ProcessReport   | $SNAILWARE_PRO_DIR/falaise/install/lib64/Falaise/modules/libFalaise_ProcessReport.so           |
|-------------------------+------------------------------------------------------------------------------------------------|
...
#+BEGIN_SRC shell
  [name="process_report" type="snemo::reconstruction::process_report_module"]
...
#+BEGIN_SRC shell :noweb yes
  <<chain_module("channel_chain", 7, channel_chain)>>
#+END_SRC
** Miscellaneous
...
#+NAME: has_pattern_id_label
#+HEADERS: :var topo="" :var logging="warning"
#+BEGIN_SRC shell
  echo '[name="'$topo'::has_pattern_id_label" type="snemo::cut::topology_data_cut"]'
  echo
  echo '#@description Cut description'
  ...
  echo 'mode.pattern_id : boolean = true'
  echo
  echo '#@description Label of the topology pattern id'
  echo 'pattern_id.label : string = "'$topo'"'
#+END_SRC
***** TOF cut
...
- select events with a given set of topology measurement which are :
  ...
  - select events with bad external probability :
    #+BEGIN_SRC shell :noweb yes
      <<tof_measurement_cut(name="2e::bad_external_probability", type="external", max="1e-5 %")>>
    #+END_SRC

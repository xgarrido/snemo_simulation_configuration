...
#+BEGIN_SRC sh
  ...
  vg_list : string[4] as path =                                              \
    "${SNAILWARE_SIMULATION_DIR}/current/scin_vg.lis"    \
    "${SNAILWARE_SIMULATION_DIR}/current/tracker_vg.lis" \
    "${SNAILWARE_SIMULATION_DIR}/current/source_vg.lis"  \
    "${SNAILWARE_SIMULATION_DIR}/current/hall_vg.lis"
#+END_SRC

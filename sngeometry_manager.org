...
#+BEGIN_SRC sh
  ...
  plugins.configuration_files : string[3] as path =                                        \
      "${SNAILWARE_SIMULATION_DIR}/current/materials_plugin.conf"      \
      "${SNAILWARE_SIMULATION_DIR}/current/magnetic_field_plugin.conf" \
      "${SNAILWARE_SIMULATION_DIR}/current/locator_plugin.conf"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  materials.configuration_files : string[7] as path =                       \
      ...
      "${SNAILWARE_SIMULATION_DIR}/current/materials_aliases.def"
#+END_SRC
...
#+BEGIN_SRC sh
  ...
  manager.field_definitions_filenames : string[1] as path = \
      "${SNAILWARE_SIMULATION_DIR}/current/magnetic_field_drivers.conf"
#+END_SRC

# -*- eval: (setenv "PATH" (concat "/home/garrido/Workdir/NEMO/supernemo/snware/falaise/install/bin:" (getenv "PATH"))) -*-
...
#+BEGIN_SRC shell
  ...
  registries : string[4] = "core" "simulation" "detector" "geometry"

...
#+BEGIN_SRC sh
  ...
  sensitive.calorimeter_SD.logging.support                 : string  = "warning"
  ...
  sensitive.xcalorimeter_SD.logging.support                : string  = "warning"
  ...
  sensitive.gveto_SD.logging.support                       : string  = "warning"
  ...
  sensitive.tracker_SD.logging.support                     : string  = "warning"

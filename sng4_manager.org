...
=sng4_module= which configuration can be changed in [[file:simulation_config.org][simulation_config]].
#+BEGIN_SRC sh
  [name="manager"]
...
cosmic muon generator. See [[file:sngenbb_manager.org][sngenbb_manager]] file.
#+BEGIN_SRC sh
...
[[https://nemo.lpc-caen.in2p3.fr/wiki/genvtx][genvtx]]. See [[file:sngenvertex_manager.org][sngenvertex_manager]] file.
#+BEGIN_SRC sh
